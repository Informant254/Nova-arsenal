...
FINDING_TYPE_MAP: dict[str, list[FrameworkControl]] = {
    ...
    "rce": [
        FrameworkControl(
            "PCI DSS",
            "6.5.3",
            "Improper error handling/command injection",
    ...
    "open_port": [
        ...
        FrameworkControl(
            "ISO 27001", "A.13.1.1", "Network controls", "Control and secure network services"
        ),
        FrameworkControl(
            "NIST SP 800-53",
            "SC-7",
    ...
    "weak_ssl": [
        FrameworkControl(
            "PCI DSS", "4.2.1", "Strong cryptography", "Use strong encryption protocols and ciphers"
        ),
        FrameworkControl(
            "ISO 27001",
            "A.10.1.1",
...
class ComplianceMapper:
    ...
    def map_finding(
        self, finding_type: str, title: str, severity: str, evidence: str = ""
    ) -> ComplianceResult:
    ...
    def list_frameworks(self) -> dict[str, list[str]]:
        ...
        return {fw: sorted(controls) for fw, controls in frameworks.items()}
